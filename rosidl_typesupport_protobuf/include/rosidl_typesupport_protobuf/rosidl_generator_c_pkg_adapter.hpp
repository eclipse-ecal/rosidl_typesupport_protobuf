...
ADAPT_PRIMITIVE_SEQUENCE_NAMESPACE(U16String)

#undef ADAPT_PRIMITIVE_SEQUENCE_NAMESPACE

using rosidl_runtime_c__String = rosidl_generator_c__String;
using rosidl_runtime_c__U16String = rosidl_generator_c__U16String;
...
#define rosidl_runtime_c__U16String__init(str) rosidl_generator_c__U16String__init(str)
#define rosidl_runtime_c__U16String__fini(str) rosidl_generator_c__U16String__fini(str)
#define rosidl_runtime_c__U16String__assignn(str, value, n) rosidl_generator_c__U16String__assignn(str, value, n)
#define rosidl_runtime_c__U16String__assign(str, value) rosidl_generator_c__U16String__assign(str, value)
#define rosidl_runtime_c__U16String__assignn_from_char(str, value, n) rosidl_generator_c__U16String__assignn_from_char(str, value, n)
#define rosidl_runtime_c__U16String__len(value) rosidl_generator_c__U16String__len(value)
#define rosidl_runtime_c__U16String__resize(str, n) rosidl_generator_c__U16String__resize(str, n)
#define rosidl_runtime_c__U16String__Sequence__init(sequence, size) rosidl_generator_c__U16String__Sequence__init(sequence, size)
#define rosidl_runtime_c__U16String__Sequence__fini(sequence) rosidl_generator_c__U16String__Sequence__fini(sequence)
#define rosidl_runtime_c__U16String__Sequence__create(size) rosidl_generator_c__U16String__Sequence__create(size)
#define rosidl_runtime_c__U16String__Sequence__destroy(sequence) rosidl_generator_c__U16String__Sequence__destroy(sequence)
